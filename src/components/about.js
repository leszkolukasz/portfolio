...
function About() {
    return (
        <section className='white-section-about'>
            ...
            <article>
                <p>I am a software engineer specializing in machine learning. Currently pursuing bachelor's degree in Computer Science and Mathematics at <strong>University of Warsaw</strong>.</p>
